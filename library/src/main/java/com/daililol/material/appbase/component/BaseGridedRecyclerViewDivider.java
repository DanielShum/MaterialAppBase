...
public class BaseGridedRecyclerViewDivider extends RecyclerView.ItemDecoration
{
    ...
    public BaseGridedRecyclerViewDivider(Context context, int dividerColor, int dividerHeight){
    ...
    public BaseGridedRecyclerViewDivider(Context context){
